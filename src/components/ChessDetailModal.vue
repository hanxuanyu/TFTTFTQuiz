<template>
  <Transition name="fade">
    <div v-if="modelValue" class="fixed inset-0 flex items-center justify-center z-50">
      ...
      <!-- 模态框内容 -->
      <div class="relative bg-white rounded-lg p-6 max-w-2xl w-full mx-4 shadow-xl transform transition-all">
        <div class="flex justify-between items-start mb-4">
          <h3 class="text-xl font-bold">{{ chess?.displayName }} 详细信息</h3>
